...
@section('title','Danh Sách Collection')
...
<main>
    <div class="top_banner version_2">
        ...
        <img src="{{ url('frontend') }}/img/bg_cat_shoes.jpg" class="img-fluid" alt="">
    </div>
    <!-- /top_banner -->
    ...
    <div class="container margin_30">
        ...
        <div class="row">
                ...
                <div class="filter_col">
                    ...
                    <div class="filter_type version_2">
                        ...
                        <div class="collapse show" id="filter_1">
                            <ul>
                                <li>
                                    <label class="container_check">{{ $item->name }} <small>12</small>
                                        <input type="checkbox">
            ...
            <div class="col-lg-9">
                ...
                <!-- /row -->
                {{ $products->links('frontend.page.custom-pagination') }}
            </div>
            <!-- /col -->
        </div>
        <!-- /row -->			
